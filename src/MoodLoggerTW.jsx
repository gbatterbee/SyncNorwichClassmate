...
const MoodLogger = () => {
  ...
  const moods = [
    { emoji: '😊', label: 'Happy', description: "I'm having a good day!", color: 'bg-yellow-100' },
    { emoji: '😐', label: 'Okay', description: "I'm feeling just okay", color: 'bg-gray-100' },
    { emoji: '😔', label: 'Sad', description: "I'm not feeling great", color: 'bg-blue-100' }
  ];
      ...
      <div className="w-full max-w-md bg-white shadow-xl rounded-2xl overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          ...
          <button
            ...
            `}
          >
            {submitted ? 'Thanks for sharing! 👍' : 'Log My Mood'}
          </button>
        </div>
      </div>
    </div>
